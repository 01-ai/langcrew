...
class TestPgVectorSearchTool:
    ...
    def test_initialization_with_custom_config(self):
        ...
        assert tool.vector_config.database_url == "postgresql://test:test@localhost:5432/testdb"
    ...
    async def test_arun_exception_handling(self, mock_create):
        ...
        mock_manager = AsyncMock()
        mock_manager.search_knowledge_bases_with_rerank.side_effect = Exception("Database connection error")
        mock_create.return_value = mock_manager
