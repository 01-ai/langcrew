...
class TestUserInputTool:
    ...
    async def test_arun_basic_question(self):
        ...
        with patch("langcrew.hitl.langchain_tools.adispatch_custom_event") as mock_event, \
             patch("langcrew.hitl.langchain_tools.interrupt", return_value=mock_user_response) as mock_interrupt:
    ...
    async def test_arun_event_dispatch_failure(self):
        ...
        with patch("langcrew.hitl.langchain_tools.adispatch_custom_event", side_effect=Exception("Event dispatch failed")) as mock_event, \
             patch("langcrew.hitl.langchain_tools.interrupt", return_value=mock_user_response) as mock_interrupt:
    ...
    async def test_arun_user_response_conversion(self):
        ...
        for mock_response in test_cases:
            with patch("langcrew.hitl.langchain_tools.adispatch_custom_event"), \
                 patch("langcrew.hitl.langchain_tools.interrupt", return_value=mock_response):
