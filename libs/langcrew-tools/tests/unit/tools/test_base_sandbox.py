...
class TestSandboxMixin:
    ...
    async def test_get_sandbox_with_config_dict_create(self, mock_async_sandbox):
        ...
        with patch.object(
            SandboxToolkit, "create_async_sandbox", return_value=mock_async_sandbox
        ) as mock_create:
    ...
    @pytest.mark.asyncio
    async def test_get_sandbox_with_config_dict_connect_resume(
        self, mock_async_sandbox
    ):
        ...
        with patch.object(
            SandboxToolkit,
            "connect_or_resume_async_sandbox",
