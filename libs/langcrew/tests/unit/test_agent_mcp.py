...
class TestAgentMCP:
    ...
    def test_agent_mcp_initialization_basic(self, mock_llm, mock_mcp_config, mock_mcp_servers):
    ...
    def test_load_mcp_tools_in_async_context(self, mock_get_loop, mock_executor,
                                           mock_llm, mock_mcp_servers, mock_mcp_tools):
    ...
    def test_load_mcp_tools_no_async_context(self, mock_asyncio_run, mock_get_loop,
                                           mock_llm, mock_mcp_servers, mock_mcp_tools):
    ...
    @pytest.mark.asyncio
    async def test_aload_mcp_tools(self, mock_adapter_class, mock_llm, 
                                   mock_mcp_servers, mock_mcp_tools):
    ...
    def test_mcp_adapter_creation_with_config(self, mock_llm, 
                                            mock_mcp_config, mock_mcp_servers):
        ...
        assert agent.mcp_config == mock_mcp_config
        assert agent.mcp_servers == mock_mcp_servers
        assert agent._mcp_adapter is None  # Not created yet since _load_mcp_tools was mocked
    ...
    @patch('langcrew.agent.asyncio.get_running_loop')
    def test_load_mcp_tools_runtime_error_handling(self, mock_get_loop, mock_llm, mock_mcp_servers):
