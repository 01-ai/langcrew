...
class LongTermMemory:
    ...
    def search(self, query: str, limit: int = 5, min_quality: float = 0.7) -> list[dict[str, Any]]:
        ...
        knowledge_items.sort(
            key=lambda x: (x.get("quality", 0), x.get("timestamp", "")),
            reverse=True
        )
    ...
    def save_task_result(self, task: str, result: str, quality: float, 
