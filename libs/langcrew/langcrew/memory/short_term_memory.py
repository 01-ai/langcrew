...
class ShortTermMemory:
    ...
    def __init__(self, checkpointer: BaseCheckpointSaver | None = None, config: MemoryConfig | None = None):
    ...
    def save(self, value: Any, metadata: dict[str, Any] | None = None, agent: str | None = None) -> None:
        ...
        if checkpoint_tuple:
            memories = checkpoint_tuple.checkpoint.get("channel_values", {}).get("memories", [])
        else:
            memories = []
    ...
    def get_context(self, thread_id: str | None = None, limit: int = 5) -> list[dict[str, Any]]:
    ...
    def search(self, query: str, thread_id: str | None = None, limit: int = 3) -> list[dict[str, Any]]:
