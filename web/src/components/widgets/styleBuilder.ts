...
/**
 * Resolve a color token into a CSS variable or raw color
 * @param colorValue Color value
 * @returns CSS color value or variable reference
 */
 ...
 * Shared style builder for Box/Row/Col (CSS-in-JS + Tailwind classes)
 */
