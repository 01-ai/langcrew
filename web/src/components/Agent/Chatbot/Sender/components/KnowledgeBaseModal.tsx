  ...
  const renderCard = (item: any) => {
    ...
    return (
      ...
      >
        ...
        {/* Description with reduced type size and bottom spacing. */}
        ...
        {/* Keep the selected checkmark in its original position. */}
        {isSelected && (
    ...
    <ConfigProvider
      theme={{
        components: {
          Modal: {
            borderRadiusLG: 20,
            contentBg: '#ffffff', // Prevent overflowing children from exposing the underlying layer.
          },
        },
      }}
    >
      <Modal
        ...
        styles={{
          ...
          header: {
            // Customize the width of the title area
            width: 420,
            marginLeft: 20,
            marginBottom: 0,
            paddingTop: 16,
      ...
      >
        ...
        {/*
         Content list:
         1. Use a transparent or white background instead of bg-gray-50/50.
         2. Use max-height instead of a fixed height.
         3. Use overflow-y-auto for scrolling.
         4. Keep pr-1 so the scrollbar does not cover the border.
        */}
        <div
