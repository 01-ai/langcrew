...
import type { FileItem, ModelItem, SenderOptionConfig } from '@/types';
      ...
      <div className="flex justify-between items-center agentx-sender-footer ml-[-12px]">
        <div className="flex gap-1 items-center agentx-sender-footer__left">
          ...
          <SenderQuickActions
            ...
            selectedKnowledgeBaseCount={selectedSenderKnowledgeBasesLength}
          ...
          {menuItems.length > 0 && showSenderActions && !isPPTAssistant && (
            <Dropdown menu={menuProps} placement="topLeft" trigger={['click']}>
              <Button
                shape="round"
          ...
          {showSenderActions && selectedScene && !isPPTAssistant && (
            <Button
              type="text"
              shape="round"
          ...
          {(agentId === '01' || isPPTAssistant) && selectedSenderKnowledgeBasesLength > 0 && (
