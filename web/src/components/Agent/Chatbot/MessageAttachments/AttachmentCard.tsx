...
// The view indicator appears on hover and remains blue while active.
...
// The download button appears on hover to the left of the view indicator.
...
const AttachmentCard: React.FC<AttachmentCardProps> = ({
  ...
  const handleClick = () => {
    ...
    if (!result.handled && result.mode === 'modal') {
      setActiveAttachment(initialAttachment);
      setOpen(true);
    }
  };
        ...
        {isImage(initialAttachment) ? (
          <FileCard
            ...
            imageProps={
              isXLargeImage
                ? {
                    preview: false,
                    // Fit the complete image within the chat column, with a maximum height of 360 px.
                    styles: {
                      // wrapper
                      root: {
                        maxWidth: '100%',
                        lineHeight: 0, // Remove the gap caused by the img baseline.
                      },
                      // img
                      image: {
                        width: '100%',
                        ...
                        maxHeight: 360,
                        objectFit: 'contain',
                        display: 'block', // Remove the gap caused by the img baseline.
                      },
                    },
                  }
                ...
                ? {
                    preview: false,
                    // Large and medium variants use fixed square thumbnails that fill the container.
                    styles: {
                      root: {
                        lineHeight: 0, // Remove the gap caused by the img baseline.
                      },
            ...
            styles={{
              root: {
                ...(isXLargeImage
                  ? {
                      // XL uses the chat-column width and preserves the image's natural aspect ratio.
                      maxWidth: '100%',
                      width: '100%',
                      height: 'auto',
                    }
              ...
              file: {
                ...(isXLargeImage
                  ? {
                      width: '100%',
                      // Let the image height adapt within maxHeight.
                      lineHeight: 0, // Avoid bottom blanks
                      fontSize: 0, // Avoid bottom blanks
                    }
                  : isLargeImage
                  ? {
                      width: '100%',
          ...
          <div
            ...
            style={{
              ...
              height: 'auto',
              boxSizing: 'border-box',
              lineHeight: 0, // Remove the gap caused by the video baseline.
              fontSize: 0, // Avoid bottom blanks
            }}
          >
            <video
              ...
              style={{
                ...
                maxHeight: 360,
                objectFit: 'contain',
                display: 'block', // Remove the gap caused by the video baseline.
              }}
            />
          </div>
        ) : (
      ...
      >
        <div className="w-full h-[600px] flex overflow-hidden">
          <div className="flex-1 h-full w-full">
            <FileReader
              key={activeAttachment.url} // Remount when the URL changes instead of waiting for content to update.
