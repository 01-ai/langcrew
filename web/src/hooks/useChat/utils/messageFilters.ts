...
/**
 * Mark every plan step status as success
 */
...
/**
 * Whether the chunk is a terminal type
 */
...
/**
 * Find a chunk with interrupt_data in the message
 * Search top-level messages and plan step children
 * @param messageItem Message item
 * @returns chunk with interrupt_data, or undefined
 */
