...
describe('clientTools', () => {
  ...
  it('To Global handler Transmit full generic context', async () => {
  ...
  it('Example handler Overwrite Global registry', async () => {
  ...
  it('Will handler Convert abnormal to failed result', async () => {
