...
const EmbeddedDemoPage: React.FC = () => {
  const [greeting, setGreeting] = useState('What can I help with today?');
        ...
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              <span className="text-blue-600 font-semibold">Embedded Mode</span>
        ...
        <div className="w-80 bg-white border-r border-gray-200 overflow-y-auto">
          <div className="p-6 space-y-6">
            ...
            <div className="pt-6 border-t border-gray-200">
              <h3 className="text-sm font-semibold text-gray-900 mb-2">Code Example</h3>
        ...
        <div className="flex-1 bg-gray-100 flex items-center justify-center p-8">
          <div className="w-full max-w-4xl h-full">
            <div className="bg-white rounded-lg shadow-lg overflow-hidden h-full">
              <AgentX displayMode="embedded" startScreen={{ greeting, prompts }} />
            </div>
          </div>
        </div>
      </div>
