...
/**
 * Save user selected models for local storage
 */
...
/**
 * Retrieving user selected models from local storage
 */
...
/**
 * Clear locally stored model selection
 */
...
/**
 * Saves the selected scene of the user (Tool）To Local Storage
 */
...
/**
 * Fetch user selection from local storage
 */
...
/**
 * Save the user selected knowledge base to local storage
 */
...
/**
 * Retrieving the knowledge base selected by the user from local storage IDs
 */
