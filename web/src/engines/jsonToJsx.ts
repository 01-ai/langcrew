 ...
 * @param {Record<string, any>} data - optional data objects in JSX , and then click the
 * @param {Record<string, React.ComponentType>} customComponents - Custom Component Map (optional)
