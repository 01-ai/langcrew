...
const UserInputBriefRenderer: React.FC<ToolBriefRendererProps> = ({ message }) => {
  ...
  // Find the assistant MessageItem in pipelineMessages that contains this user_input,
  // The next user MessageItem content is the submitted answer
  ...
  const renderMultiSelectQuestion = () => {
    // Restore selected options from submittedContent:
    // Prefer JSON.parse (storage may serialize as array); else split on ', '
