...
import { UserInputChunk, type RenderHitlApproval } from '@/types';
...
vi.mock('@/assets/svg/user-input/check.svg?react', () => ({
...
describe('UserInputBriefRenderer', () => {
  ...
  it('renders HITL approval action description, two buttons, and a custom message input', () => {
    ...
    expect(screen.getByText(/是否同意更新项目需求字段/)).not.toBeNull();
  ...
  it('renders a custom HITL approval card and keeps approval submission in the host UI', () => {
