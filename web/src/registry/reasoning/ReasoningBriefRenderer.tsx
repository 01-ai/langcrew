...
import ExpandCollapseIcon from '@/components/Agent/Chatbot/ExpandCollapseIcon';
...
const ReasoningBriefRenderer: React.FC<BriefRendererProps> = ({ message }) => {
  ...
  // If content Empty, no components displayed
  if (!message.content || message.content?.trim() === '') {
    return null;
  }

  return (
    <div className="bg-gray-100 hover:bg-gray-200 rounded-lg my-1 transition-colors w-full max-w-full min-w-0 overflow-hidden">
      <div
