...
```mermaid
graph TD
    A[Web Client] -->|HTTP Request| B[FastAPI Server]
...
- **[Getting Started](/guides/web/getting-started)** - Quick setup and basic examples
- **[HTTP Server](/guides/web/http-server)** - Advanced configuration and production deployment
- **[Communication Protocol](/guides/web/protocol)** - Complete message specifications