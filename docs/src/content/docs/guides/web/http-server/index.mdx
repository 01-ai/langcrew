...
- **[Getting Started](/guides/web/getting-started)** - Basic examples and complete deployment setup
- **[Communication Protocol](/guides/web/protocol)** - Message specifications and API reference
