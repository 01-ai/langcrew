...
For additional HITL examples and patterns, check out the [examples directory](https://github.com/01-ai/langcrew/tree/main/examples/components/hitl):
...
Navigate to these files in your local copy or [view them online](https://github.com/01-ai/langcrew/tree/main/examples/components/hitl) to explore different HITL scenarios.
...
Now that you have HITL working:

- **[Configuration Guide](/guides/hitl/configuration)** - Learn all configuration options
- **[HITL Concepts](/concepts/hitl)** - Understand HITL architecture and components
- **[Examples](https://github.com/01-ai/langcrew/tree/main/examples/components/hitl)** - Real-world implementations
