...
- **[Create Your First Agent](/guides/agents/quickstart)** - Put tools to work
- **[MCP Integration](/guides/tools/tool-mcp)** - Connect external MCP servers  
- **[Core Concepts](/concepts/)** - Understanding the LangCrew system
